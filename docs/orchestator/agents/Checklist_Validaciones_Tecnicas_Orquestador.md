...
|**POST-09**|flops_window_estimate = run_flops_total × (delta_t_ns / run_duration_ns).<br>Los FLOPs totales de la corrida se obtienen del stdout del binario<br>NPB/STREAM/ERT, nunca de un contador de hardware de FLOPs.|☐|
