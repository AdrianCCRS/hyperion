...
Árbol de profundidad 1 & 0.630 & 0.566 a 0.700 & 0.713 & 103~\textmu s \\
Regresión logística (6 var.) & 0.680 & 0.618 a 0.742 & 0.765 & 452~\textmu s \\
Regresión logística (12 var.) & 0.660 & 0.606 a 0.725 & 0.777 & 458~\textmu s \\
Extra Trees (6 var.) & 0.732 & 0.666 a 0.804 & 0.717 & 5328~\textmu s \\
Random Forest (6 var.) & 0.737 & 0.675 a 0.803 & 0.763 & 5282~\textmu s \\
\textbf{XGBoost (6 var.)} & \textbf{0.728} & 0.669 a 0.790 & 0.760 & 401~\textmu s \\
XGBoost (12 var.) & 0.724 & 0.662 a 0.791 & 0.783 & 398~\textmu s \\
\bottomrule
\end{tabular}
\end{table}
...
La salida \textit{revisar} activa una política conservadora: el sistema conserva la frecuencia vigente y espera dos intervalos \textit{uncore} válidos consecutivos antes de aceptar una caracterización física. En cuanto al costo, la inferencia de una fila toma 240~\textmu s de mediana y 401~\textmu s en el percentil 99 para XGBoost, frente a 419 y 452~\textmu s de la regresión logística y 5.1 y 5.3~ms de los bosques, medidos en un nodo de cómputo de pacca. Estas cifras incluyen la sobrecarga del intérprete de Python y son una cota superior para una implementación integrada en el agente.
