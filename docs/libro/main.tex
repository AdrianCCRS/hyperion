...
La primera implementación predecía $\log(\text{energía})$ y $\log(\text{tiempo})$ absolutos por acción, calibrando el error como $\left|\text{predicho}/\text{real} - 1\right| \times 100$. Verificado sobre los 5\,441 registros reales de pacca: en configuraciones con EDP diminuto (\textit{axpy} $N=10\,000$ en frío, $EDP \approx 1{,}66\times10^{-8}$~J\,s) un error absoluto minúsculo del modelo se traduce en errores porcentuales de hasta 14\,000\,000\,\%, porque se divide entre una magnitud casi nula. El percentil 95 de incertidumbre por contexto llegaba a 121\,937\,\% incluso en el contexto más limpio, forzando abstención en el 100\,\% de los casos sin que eso reflejara una limitación real del modelo.
