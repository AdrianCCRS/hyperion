...
% Separación entre el rótulo de tabla/figura y su contenido
...
\input{secciones/00_frontmatter}
\input{secciones/01_marco_referencia}
\input{secciones/02_metodologia}
\input{secciones/03_resultados}
\input{secciones/04_discusion}
...
\input{secciones/A1_anexo_metodologia_detalle}
\input{secciones/A2_anexo_resultados_complementarios}
