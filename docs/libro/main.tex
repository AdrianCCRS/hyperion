...
A ellas se suman tres tareas derivadas de los resultados de las secciones \ref{sec:resultados-frontera-energia} a \ref{sec:resultados-diversidad-catalogo}. Primera, completar la rejilla de frecuencias de GPU en la banda 1110--1410~MHz, donde se concentra la totalidad del ahorro observado y donde se decide si el margen estrecho de la Tabla \ref{tab:margen-politica} es una limitación de muestreo o del dispositivo. Segunda, evaluar el reloj de memoria del acelerador como segundo mando de actuación: este trabajo escaló únicamente el reloj de los multiprocesadores, lo que explicaría por qué las cargas limitadas por ancho de banda no respondieron, y varios de los trabajos de referencia escalan ambos relojes conjuntamente \cite{Fan2020,Mei2016}. Tercera, atacar el piso de potencia del anfitrión por la vía que la sección \ref{sec:resultados-frontera-energia} identifica como plausible y no medida --- reducir el número de núcleos delegados, o liberarlos mientras el acelerador trabaja --- y no por la de reducir su frecuencia, que ya se midió contraproducente.
