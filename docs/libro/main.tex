...
\begin{table}[H]
\centering
\caption{Estados de frecuencia de la campaña de caracterización (Fase 1).}
...
\begin{table}[H]
\centering
\caption{Rejilla fina de frecuencia empleada como espacio de acciones del selector. Las fracciones se aplican sobre el rango real de cada dispositivo, por lo que los mismos identificadores designan frecuencias absolutas distintas en la CPU y en el acelerador.}
...
\begin{table}[H]
\centering
\caption{Matriz experimental de las dos campañas del catálogo dual.}
...
\begin{table}[H]
\centering
\caption{Fórmulas analíticas de trabajo y de tráfico lógico por despacho, empleadas como descriptores estáticos. $N$ es el parámetro de tamaño de la operación.}
...
\begin{table}[H]
\centering
\caption{Espacios de hiperparámetros explorados por familia.}
