...
Cuarta, y de mayor consecuencia para las fases siguientes, el catálogo original de la Fase 1 no contiene alternancia de régimen intra-ejecución (sección \ref{sec:resultados-homogeneidad}): la fracción media de ventanas de clase minoritaria dentro de cada carga es del 4.0\% y cuatro cargas son de un solo régimen en la totalidad de sus ventanas. El conjunto sostiene la caracterización de regímenes de carga, pero no la evaluación de un clasificador de fases intra-ejecución, y esa insuficiencia se documenta empíricamente: ningún modelo evaluado supera al predictor trivial bajo partición por carga. La ampliación descrita en la sección \ref{sec:resultados-multifasico} está dirigida específicamente a esta limitación, y su campaña ya concluyó (320 de 320 combinaciones aceptadas); lo que permanece abierto no es la disponibilidad del dato sino un análisis posterior, todavía no realizado, que cruce las marcas de transición de fase declaradas por el microbenchmark contra la clasificación por ventana para determinar el retardo de detección --- el objetivo de diseño declarado al final de la sección \ref{sec:resultados-multifasico}.
