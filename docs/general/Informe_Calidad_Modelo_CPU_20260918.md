...
Reexportado con las 30 familias (`export_cpu_selective_candidate.py`, pacca01): `/home/latorresn/hyperion-results/final/models/cpu_final_30fam_20260920/cpu_xgboost_pmu_interactions.joblib`; metadatos en `docs/libro/datos/cpu_calidad_30fam/modelo_serializado_metadata.json`. Se ajustó con 42 014 intervalos (muestra con tope de 1000 por celda, tras retirar tasas indefinidas). El LOFO interno con cobertura mínima 0.60 eligió el umbral **0.90** (con las 24 familias había elegido 0.85). El libro y las figuras se regeneraron con 0.90: cobertura 0.666, exactitud por celda 0.755, F1 macro agrupada 0.874, sensibilidad compute 0.786; abstenerse al azar con cobertura equivalente da 0.724. La figura de abstención usa una sola semilla (0.765 con cobertura 0.678). Las figuras se regeneraron en pacca01 y se revisaron una a una por solapamientos de leyendas.
