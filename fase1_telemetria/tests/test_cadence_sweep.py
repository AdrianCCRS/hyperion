...
def _summary(q_ns, *, steps):
    return {
        ...
        "signal_step_analysis": {
            "power_mw": {"n_consecutive_changes_lower_bound": steps["power_mw"]},
            "util_pct": {"n_consecutive_changes_lower_bound": steps["util_pct"]},
            "sm_clock_mhz": {"n_consecutive_changes_lower_bound": steps["sm_clock_mhz"]},
        },
    }
