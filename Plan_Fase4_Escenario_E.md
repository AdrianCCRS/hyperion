...
| 5. Kernels E-B elegidos | Provisional, a confirmar con el sondeo 7651: `gpu_stream_bw --arraysize 100000000 --numtimes 5000`, `gpu_rajaperf_indexlist_3loop`, `rodinia_backprop 8388480` (memory) y `rodinia_lavamd -boxes1d 100` (compute). Ninguno está entre las 16 familias del entrenamiento | `survey` job 7651 |
| Sondeo de duración | job 7651 | |
| Pre-vuelo | job 7652 | |
| Matriz E | job 7653 | |
