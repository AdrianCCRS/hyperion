...
// PARCHE (overflow int32, N>~46000): max_rows/max_cols pasan a long.
void nw_optimized(int *input_itemsets, int *output_itemsets, int *referrence,
        long max_rows, long max_cols, int penalty)
{
#ifdef OMP_OFFLOAD
...
{
    long max_rows, max_cols;  // PARCHE (overflow int32, N>~46000)
    int penalty;
    ...
    max_rows = max_rows + 1;
    max_cols = max_cols + 1;
    referrence = (int *)malloc( (size_t)max_rows * (size_t)max_cols * sizeof(int) );
    input_itemsets = (int *)malloc( (size_t)max_rows * (size_t)max_cols * sizeof(int) );
    output_itemsets = (int *)malloc( (size_t)max_rows * (size_t)max_cols * sizeof(int) );
