...
| `gpu_loop/classifier.py` (`HistoricalGpuClassifier`) | ✅ Construido y probado (10/10 tests, incluido contra el `.joblib` real) | Carga el candidato de Fase 2 (`fase2_clasificador/models/gpu_random_forest_historical_20260923_sin_reloj.joblib` (sin reloj ni potencia; el anterior `gpu_regresion_log_historical_20260922` dependia del reloj, ver auditoria job 7601)) y aproxima con un buffer móvil la mediana/std con que se entrenó -- ver limitaciones abajo |
