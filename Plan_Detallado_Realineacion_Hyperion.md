...
| `orchestrator/native/blocking_sync_shim.cpp` | `main` | Shim necesario para §4.1 — existe; debe **extenderse** para interceptar `cudaLaunchKernel` y emitir eventos de fase (§4.1). Hoy solo fuerza `cudaDeviceScheduleBlockingSync` | **Verificar sincronización real en el nodo de ejecución, completar y extender** |
