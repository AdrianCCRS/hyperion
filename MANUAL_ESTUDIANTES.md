...
| `ipc`, `mpki`, `cache_miss_rate`, `stall_mem_ratio` | Contadores baratos -- lo que el clasificador SÍ puede usar en producción |
...
baratos** (`ipc`, `mpki`, `cache_miss_rate`, `stall_mem_ratio`, `ips`,
